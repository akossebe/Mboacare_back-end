...
public interface ConsultationRepository extends JpaRepository<Consultation, Long> {
    ...
    Page<Consultation> findByIdPatient(Long idPatient, Pageable pageable);
    Page<Consultation> findByIdMedecin(Long idMedecin, Pageable pageable);
    Page<Consultation> findByIdPatientAndIdMedecin(Long idPatient, Long idMedecin, Pageable pageable);
}
